...
values('hongkd@aaa.com','1111','홍길동', now(),'서울시 마포구 양화로6길 9', '010-1111-1111');

insert into member(id, passwd, name, reg_date, address,tel) 
values('kingdora@dragon.com','1234','김개동', now(),'경기도 구리시 아차산로 439', '010-3333-3333');
...
select * from book where book_kind='300'
